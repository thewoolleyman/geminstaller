module GemInstaller
  class MissingDependencyFinder
    ...
    def find(gem)
      ...
      dependency_output_lines = @gem_command_manager.dependency(gem, common_args)
      dependency_output_lines.each do |dependency_output_line|
        ...
        dependency_gem = GemInstaller::RubyGem.new(name, :version => version_spec, :install_options => gem.install_options)
