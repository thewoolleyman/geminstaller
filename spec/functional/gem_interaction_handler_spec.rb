...
describe "a GemInteractionHandler instance with a non-multiplatform dependent gem and non-multiplatform dependency gem" do
  ...
  it "should raise UnauthorizedDependencyPromptError from handle_ask_yes_no if question is a dependency prompt" do
  ...
  it "should call noninteractive_chooser for dependent gem if handle_choose_from_list is passed an install-formatted list for the dependent gem" do
    @gem_interaction_handler.dependent_gem = @dependent_gem
  ...
  it "should choose properly if handle_choose_from_list is passed an install-formatted list for a non-dependent gem" do
    @gem_interaction_handler.dependent_gem = @dependent_gem
...
describe "a GemInteractionHandler instance with a non-multiplatform dependency gem and multiplatform dependent gem" do
  before(:each) do
  ...
  it "should choose multiplatform dependency gem before ruby platform" do
    @gem_interaction_handler.dependent_gem = @dependent_gem
  ...
  it "should choose ruby platform if no matching valid binary platform is found" do
    @gem_interaction_handler.dependent_gem = @dependent_gem
