...
context "An output filter" do
  ...
  specify "should pass rubygems stdout message to output proxy if stdout rubygems_output option is set" do
  ...
  specify "should pass not rubygems stdout message to output proxy if stdout rubygems_output option is not set" do
